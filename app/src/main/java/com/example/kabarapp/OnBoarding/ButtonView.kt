...
fun ButtonView(modifier: Modifier = Modifier
    ...
    Button(onClick = onClick, modifier = modifier , colors = ButtonDefaults.buttonColors(
        ...
        Text(text = text , style = MaterialTheme.typography.
        labelMedium.copy(fontWeight = FontWeight.SemiBold))
    }
}

@Composable
fun ButtonTextView(modifier: Modifier = Modifier
, onClick: () -> Unit , text: String ) {
    TextButton(onClick = onClick) {
        Text(text = text , style = MaterialTheme.typography.
        labelMedium.copy(fontWeight = FontWeight.SemiBold) , color = Color.Gray)
